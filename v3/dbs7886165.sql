...
--
-- Host: localhost:3306
-- Generation Time: Jul 19, 2022 at 09:54 PM
...
--
-- Table structure for table `photocall`
--
...
--
-- Dumping data for table `photocall`
--
...
CREATE TABLE `premium_request` (
  ...
  `devicesAvailable` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `users` (
  ...
  `subscriptionExpDate` date DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `users` (`id`, `name`, `email`, `password`, `telegram`, `subscription`, `subscriptionExpDate`) VALUES
(1, 'Franklin', 'franklinjosue.net@gmail.com', '9d5a3ae9b2110c22922b7e8aae6563d8', 'fjosue4', 2, NULL),
(2, 'Erick ', 'erick_agc2903@hotmail.com', 'e761a9a50741e7f1d0c07d713ad2190d', '@fmery1', 0, NULL),
(3, 'Erick', 'erick10sapon@gmail.com', '857e0df9d8a46ea06eeef8c4124047bc', 'Erick_sapon10', 0, NULL),
(4, 'Jordi', 'jordimartinezpelaez@gmail.com', 'e7fa7527aaf1099c968fa0c6f5380a41', 'Jordimartinezp', 0, NULL),
(5, 'Gabriel Ángel caro muñoz', 'gabrielcaromunoz2@gmail.com', '2c92292145b55ea1e73ae0305c13e562', 'Gabo Pajín', 0, NULL),
(6, 'Alberto Och', 'josmaigarrido@gmail.com', '3c2bb3a4f43ded9e3b61f965642389ed', 'Alvillaoch', 0, NULL),
(7, 'Alexander', 'slowdsports@gmail.com', 'c3284d0f94606de1fd2af172aba15bf3', 'slowdmelendez360', 2, NULL),
(8, 'Rudy', 'rudycent2@gmail.com', 'fb92f5e78eceb853c992da6b4a87a162', '58155868', 0, NULL),
(9, 'Cristhian', 'cristhiananariba7u7@gmail.com', 'd5891915b10fb3a2791d9697912da35e', '+504 8823 5437', 0, NULL);
