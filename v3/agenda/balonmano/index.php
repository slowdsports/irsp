    ...
    <div class="section mt-2">
        <div class="container">
            <div class="row">
                ...
                <div style="" class="col-6">
                    <a href="../../tv/epg?url=epg&c=253">
                        <div class="card product-card liga-card">
                            <div class="card-body">
                                <center>
                                    <img width="48px" src="https://i.ibb.co/w0qg9JF/trans.png" style="background-image: url('../../assets/img/canales/e3.png'); background-size: contain; background-repeat: no-repeat;" class="image" alt="product image" />
                                    <h2 class="title text-center">Esport3</h2>
                                </center>
                            </div>
                        </div>
                    </a>
                ...
                ?>
                <!-- Elemento -->
                <div <?=$display?> class="col-12 mycard">
