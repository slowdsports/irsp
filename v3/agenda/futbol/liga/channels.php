...
if($canal === "M+ Liga de Campeones 2" || $canal === "mlcamp2"){
    ...
    $canalop2 = '
    <li>
        <a class="justify-content-center" href="https://irpc.ga/mg/play/sandbox.php?get=https://megadeportes.live/eventos/?r=Ly9ncmVnb3JzYW1zYS5saWZlL2VtYmVkL2VzL21saWdhZGVjYW1wZW9uZXMyLnBocA==">
        <i class="flag es"></i>
...
if($canal === "M+ Liga de Campeones 3" || $canal === "mlcamp3"){
    ...
    $canalop2 = '
    <li>
        <a class="justify-content-center" href="https://irpc.ga/mg/play/sandbox.php?get=https://megadeportes.live/eventos/?r=Ly9ncmVnb3JzYW1zYS5saWZlL2VtYmVkL2VzL21saWdhZGVjYW1wZW9uZXMzLnBocA==">
        <i class="flag es"></i>
...
if($canal === "M+ Liga de Campeones 4" || $canal === "mlcamp4"){
    ...
    $canalop2 = '
    <li>
        <a class="justify-content-center" href="https://irpc.ga/mg/play/sandbox.php?get=https://megadeportes.live/eventos/?r=Ly9ncmVnb3JzYW1zYS5saWZlL2VtYmVkL2VzL21saWdhZGVjYW1wZW9uZXM0LnBocA==">
        <i class="flag es"></i>
...
if($canal === "M+ Liga de Campeones 5" || $canal === "mlcamp5"){
    ...
    $canalop2 = '
    <li>
        <a class="justify-content-center" href="https://irpc.ga/mg/play/sandbox.php?get=https://megadeportes.live/eventos/?r=Ly9ncmVnb3JzYW1zYS5saWZlL2VtYmVkL2VzL21saWdhZGVjYW1wZW9uZXM1LnBocA==">
        <i class="flag es"></i>
...
if($canal === "M+ Liga de Campeones 7" || $canal === "mlcamp7"){
    ...
    $canalop2 = '
    <li>
        <a class="justify-content-center" href="https://irpc.ga/mg/play/sandbox.php?get=https://megadeportes.live/eventos/?r=Ly9ncmVnb3JzYW1zYS5saWZlL2VtYmVkL2VzL21saWdhZGVjYW1wZW9uZXM3LnBocA==">
        <i class="flag es"></i>
...
if($canal === "M+ LaLiga" || $canal === "M+ LaLigaTV" || $canal === "bar"){
    ...
    <!--
    <li class="hidden">
        <a class="justify-content-center" href="'.$app.'/agenda/play?c=barsd">
        <i class="flag es"></i>
...
if($canal === "M+ LaLiga 2" || $canal === "mlaliga2"){
    ...
    $canalop2 = '
    <li>
        <a class="justify-content-center" href="'.$app.'/agenda/play?c=mlaliga2">
        <i class="flag es"></i>
...
if($canal === "M+ LaLiga 3" || $canal === "mlaliga3"){
    ...
    $canalop2 = '
    <li>
        <a class="justify-content-center" href="'.$app.'/agenda/play?c=mlaliga3">
        <i class="flag es"></i>
...
if($canal === "M+ LaLiga 7" || $canal === "mlaliga7"){
    ...
    $canalop2 = '
    <li>
        <a class="justify-content-center" href="'.$app.'/agenda/play?c=mlaliga7">
        <i class="flag es"></i>
...
if($canal === "DAZN2" || $canal === "DAZN2" || $canal === "dazn2"){
    ...
    <li>
        <a class="justify-content-center" href="'.$app.'/agenda/play?c=dazn2">
        <i class="flag es"></i>
        DAZN 2 | VIP HD
        </a>
    </li>';
...
if($canal === "DAZN LaLiga" || $canal === "DAZN LaLiga" || $canal === "daznlaliga"){
    ...
    <li>
        <a class="justify-content-center" href="'.$app.'/agenda/play?c=daznlaliga">
        <i class="flag es"></i>
        DAZN LaLiga | VIP HD
        </a>
    </li>';
...
if($canal === "foxsportsmx" || $canal === "foxsportsmx"){
    ...
    $canalop2 = '
    <li>
        <a class="justify-content-center" href="'.$app.'/tv/epg/?c=565">
        <i class="flag mx"></i>
        Fox Sports | HD
        </a>
    </li>';
