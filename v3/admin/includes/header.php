          ...
          <li class="nav-item menu-items">
            ...
            <div class="collapse" id="ui-agenda">
              <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item"> <a class="nav-link" href="<?=$base?>balonmano.php">Balonmano</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item menu-items">
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <nav class="navbar p-0 fixed-top d-flex flex-row">
          <div class="navbar-brand-wrapper d-flex d-lg-none align-items-center justify-content-center">
            <a class="navbar-brand brand-logo-mini" href="<?=$base?>"><img src="<?=$base?>assets/images/logo-mini.svg" alt="logo" /></a>
          </div>
