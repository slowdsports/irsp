<?php
include ('includes/header.php'); include('backend/paises.php');
?>
            ...
            <div class="page-header">
                ...
                <table id="dTable" class="table table-dark">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><?=$cnt?></td>
                            <td><?=$pai['countryName']?></td>
                            <td><i class="flag <?=$pai['countryImg']?>"></td>
                            <td>
                            <button type="button" class="btn btn-sm btn-outline-primary btn-icon-text" data-toggle="modal" data-target="#modal<?=$pai['countryId'];?>">
                            <i class="mdi mdi-tooltip-edit btn-icon-prepend"></i>Editar</button>

                            <a href="?pid=<?=$pai['countryId']?>" type="button" class="btn btn-sm btn-outline-danger">
                            <i class="mdi mdi-delete btn-icon-prepend"></i>Borrar</a>
                            </td>
                        </tr>
                        <!-- Modal -->
                        <div class="modal fade" id="modal<?=$pai['countryId']?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel">Editar <?=$pai['countryName']?></h5>
                                    </div>
                                    <div class="modal-body">
                                        <form method="post" class="forms-sample">
                                            <div class="form-group">
                                            <input readonly type="text" class="form-control text-light" id="countryId" name="countryId" value="<?=$pai['countryId']?>"/>
                                                <label for="countryName">Nombre</label>
                                                <input type="text" class="form-control text-light" id="countryName" name="countryName" value="<?=$pai['countryName']?>"/>
                                            </div>
                                            <div class="form-group">
                                                <label for="countryImg">Imagen</label>
                                                <input type="text" class="form-control text-light" id="countryImg" name="countryImg" value="<?=$pai['countryImg']?>"/>
                                            </div>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form method="post" class="forms-sample">
                                            <div class="form-group">
                                                <label for="countryName">Nombre</label>
                                                <input type="text" class="form-control text-light" id="countryName" name="countryName"/>
                                            </div>
                                            <div class="form-group">
                                                <label for="countryImg">Imagen</label>
                                                <input type="text" class="form-control text-light" id="countryImg" name="countryImg"/>
                                            </div>
