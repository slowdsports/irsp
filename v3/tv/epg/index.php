...
<div class="container">
    ...
    <center>
        ...
        <div class="tab-content" id="myTabContent">
            <div class="tab-pane fade <?=$isHls?>" id="jw" role="tabpanel" aria-labelledby="jw-tab">
                <!-- M3U8 -->
            ...
            <div class="tab-pane fade show active <?=$isPluto?>" id="hls" role="tabpanel" aria-labelledby="hls-tab">
                <!-- Video TAG -->
